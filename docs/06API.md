...
![image.png](/upload/computerselfeducationroad/image-17aa32febed04efcbe50a65b2fac4def.png)
...
![image.png](/upload/computerselfeducationroad/image-e01383eea3144b69ba6bcab4736a30f2.png)
...
![image-1657519260384](/upload/computerselfeducationroad/image-1657519260384.png)

在下图中，系统中的所有入口点（REST、GraphQL 和 RPC）都将使用相同的验证、授权和错误处理规则进行处理。

![image-1657519556322](/upload/computerselfeducationroad/image-1657519556322.png)
